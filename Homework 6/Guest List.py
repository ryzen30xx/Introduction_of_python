...
if remove_question.lower == "yes":
    ...
    print("wtf guest ?") if guest_remove not in guest_list else guest_list.remove(guest_remove);print(f"Guest {guest_remove} has been removed from the list.");print(f"The updated guest list is: {guest_list}")
